...
const TEX_RAND = 0.08;
function texCm(){ const v=TEX_CM[texKey()]; return v===undefined ? 40 : v; }
...
function textur3D(key){
  ...
  im.onload=()=>{
    try{ const w=im.naturalWidth, h=im.naturalHeight, ix=Math.round(w*TEX_RAND), iy=Math.round(h*TEX_RAND);
