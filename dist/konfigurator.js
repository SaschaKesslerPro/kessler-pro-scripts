...
function updateSticky(){
  ...
  /* Erst versuchen, die Draufsicht so weit zu verkleinern, dass Vorschau UND
  ...
  /* Passt die ganze Spalte ins Fenster, bleibt sie wie bisher komplett stehen.
     ...
     mit — so bleibt die Platte beim Konfigurieren sichtbar und der CTA trotzdem
     erreichbar, ganz ohne eingeblendete Leisten. */
  el.classList.toggle('is-split', !passt);
  el.style.setProperty('--kfg-top', top+'px');
  el.style.top = passt ? top+'px' : '';
}
