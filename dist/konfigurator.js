/*! Kessler PRO — Tischplatten-Konfigurator  v1.16.0
...
/* ┌ PREISE MULTIPLEX / NAEHTISCHPLATTE — Liste Senior 30.07.2026 ────────────┐
   │ nicht gefraest 5 €, gefraest 45° 10 €, halbrund 16 € — JE LAUFENDEM METER │
   │ Kante (Freigabe Sascha 30.07.). Vorher: 0 / 5 / 8 €/lfm.                  │
   │ ACHTUNG, offener Punkt: auf der Liste steht darueber "Preise sind doppelt │
   │ zu hoch". Eine zweite, ebenso plausible Lesart ist, dass 5/10/16 die      │
   │ Preise der LACKIERTEN Naturkante sind (jeweils das Doppelte der bisher    │
   │ unlackierten 0/5/8) und die alten Werte unveraendert bleiben. Falls das   │
   │ gemeint war: hier die Werte zuruecksetzen und LACK_FAKTOR nutzen.         │
   └──────────────────────────────────────────────────────────────────────────┘ */
const EDGE_MPX = [['nicht','Nicht gefräst',5,'+ 5 €/lfm','#1E1E1E'],
                  ['f45','Gefräst 45°',10,'+ 10 €/lfm','#8a6844'],
                  ['halbrund','Halbrund',16,'+ 16 €/lfm','#4a7a9b'],
...
function isLack(){ return !!S.extras.lack && (S.mat==='mpx'||S.mat==='szwal') && S.edges.some(e=>e!=='abs'); }
...
function render(){
  ...
  if(isLack())rows.push(['Kante lackiert','im Angebot']);
...
function buildConf(){
  ...
  if(isLack()) items.push({t:'Kante lackiert', s:4, warn:true});
