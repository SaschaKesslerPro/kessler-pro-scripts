...
function drawStage(){
  ...
  const svg=$('stage'); const W=600,H=444,PADL=28,PADR=54,PADT=26,PADB=54;
...
function dimSkala(){
  ...
  st.style.setProperty('--dim-fs', Math.round(ziel/m*10)/10+'px');
...
function updateSticky(){
  ...
  if(window.innerWidth<980){
    ...
    const cap=Math.round(window.innerHeight*0.42)+'px';
