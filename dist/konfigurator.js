...
function drawStage(){
  ...
  if(S.form==='round'){
    ...
    const xc0=x+(bg.welle?bg.a:bg.a+bg.r1)*sc, xc1=x+(bg.L-bg.b-(bg.welle?0:bg.r2))*sc;
    ...
    const cText=bg.welle ? `Mulde ${zz(bg.oeffnung)} · Tiefe ${zz(bg.t)}` : `C ${zz(bg.c)} · Tiefe ${zz(bg.t)}`;
    ...
    const bogenPlatz=tief>luft*1.5 && !bg.welle;   /* die Welle hat keine Winkel */
