/*! Kessler PRO — Tischplatten-Konfigurator  v1.0.0
...
(function(){
  ...
  var VERSION = '1.0.0';
  var BASE    = 'https://cdn.jsdelivr.net/gh/SaschaKesslerPro/kessler-pro-scripts@e39f969405f6a1adc0f10ea5b6a7957711631f55';
  ...
  function boot(){
    ...
    if (!root && /\/konfigurator(\/|$)/.test(location.pathname)) {
      ...
      var host = document.querySelector('.page-wrapper, main, [role="main"]') || document.body;
...
/* ═══════════════════════ CSS ═══════════════════════ */
var KFG_CSS = "\n  :root{\n    --ink:#1E1E1E; --deep:#0A0A0A; --card:#F2F0EB; --alt:#FAFAFA; --hair:#E5E5E5;\n    --ok:#1c7a3d; --ok-bg:#e8f4ec; --warn:#9a6b12; --warn-bg:#faf3e2;\n    --s-3xs:4px; --s-2xs:8px; --s-xs:12px; --s-s:16px; --s-m:24px; --s-l:32px; --s-xl:48px; --s-2xl:64px;\n    --r:8px;\n  }\n  *{box-sizing:border-box;margin:0;padding:0}\n  button,select,input,textarea{font-family:inherit}\n  body{font-family:'Onest','DM Sans',sans-serif;color:var(--ink);background:#fff;-webkit-font-smoothing:antialiased}\n\n  .demo-note{background:var(--deep);color:#fff;font-size:11px;letter-spacing:.06em;text-transform:uppercase;\n    text-align:center;padding:6px 16px;font-weight:400}\n  .demo-note strong{font-weight:600}\n  header.site{border-bottom:1px solid var(--hair);background:#fff;position:sticky;top:0;z-index:50}\n  .site_inner{max-width:1280px;margin-inline:auto;padding:var(--s-s) clamp(16px,4vw,80px);display:flex;align-items:center;justify-content:space-between}\n  .logo{display:block;line-height:0}\n  .logo svg{height:36px;width:auto;display:block}\n  .logo svg path{fill:var(--ink)}\n  .site_meta{font-size:12px;color:#777;display:none;font-weight:300;letter-spacing:.04em}\n  @media(min-width:768px){.site_meta{display:block}}\n\n  .kfg_hero{max-width:1280px;margin-inline:auto;padding:var(--s-l) clamp(16px,4vw,80px) var(--s-s)}\n  .kfg_hero h1{font-size:clamp(24px,3.4vw,36px);font-weight:500;letter-spacing:-.01em}\n  .kfg_hero p{margin-top:var(--s-2xs);color:#555;font-size:15px;max-width:680px}\n  .kfg_hero .anchor{color:var(--ink);font-weight:600}\n\n  .kfg_layout{max-width:1280px;margin-inline:auto;padding:var(--s-s) clamp(16px,4vw,80px) 140px;\n    display:grid;grid-template-columns:1fr;gap:var(--s-m)}\n  @media(min-width:980px){\n    .kfg_layout{grid-template-columns:55fr 45fr;gap:var(--s-xl);padding-bottom:var(--s-2xl)}\n  }\n\n  /* \u2500\u2500 Preview \u2500\u2500 */\n  .kfg_preview{background:var(--card);border-radius:16px;padding:var(--s-s);position:relative}\n  @media(min-width:980px){\n    .kfg_preview{padding:var(--s-m)}\n    .kfg_stickycol{position:sticky;top:84px;align-self:start}\n  }\n  .kfg_preview-badge{position:absolute;top:var(--s-s);left:var(--s-s);z-index:2;display:inline-flex;align-items:center;gap:6px;\n    font-size:12px;font-weight:500;padding:6px 12px;border-radius:var(--r);background:var(--ok-bg);color:var(--ok)}\n  .kfg_preview-badge.is-sonder{background:var(--warn-bg);color:var(--warn)}\n  .kfg_preview-badge .dot{width:7px;height:7px;border-radius:50%;background:currentColor}\n  .kfg_viewtoggle{position:absolute;top:var(--s-s);right:var(--s-s);z-index:2;display:flex;gap:2px;background:#fff;\n    border:1px solid var(--hair);border-radius:var(--r);padding:2px}\n  .kfg_viewtoggle button{border:0;background:transparent;font-size:12px;font-weight:500;padding:6px 14px;\n    cursor:pointer;border-radius:6px;min-height:32px;color:#777}\n  .kfg_viewtoggle button.is-active{background:var(--ink);color:#fff}\n  .kfg_preview-stage{width:100%;aspect-ratio:10/7.4;display:block}\n  #stage3d{width:100%;aspect-ratio:10/7.4;display:none;border-radius:var(--r);cursor:grab;touch-action:none}\n  .kfg_preview-hint{text-align:center;font-size:12px;color:#8a877f;padding-top:var(--s-2xs)}\n  .ic-svg{width:14px;height:14px;flex:0 0 auto}\n  .kfg_edge{cursor:pointer;transition:opacity .15s}\n  .kfg_edge:hover{opacity:.75}\n  .dim-line{stroke:#9b978c;stroke-width:1}\n  .dim-text{font-family:'Onest',sans-serif;font-weight:300;font-size:13px;fill:#6b6862;letter-spacing:.03em}\n\n  /* Detail */\n  .kfg_detail{margin-top:var(--s-xs);background:#fff;border-radius:var(--r);padding:var(--s-xs)}\n  .kfg_detail summary{display:none}\n  .kfg_detail-inner{display:flex;align-items:center;gap:var(--s-s);position:relative}\n  .kfg_detail-badge{position:absolute;top:var(--s-2xs);left:var(--s-2xs);z-index:2;font-size:10px;font-weight:500;\n    letter-spacing:.05em;text-transform:uppercase;padding:3px 8px;border-radius:var(--r);\n    background:#ffffffd9;color:#666;border:1px solid var(--hair)}\n  .kfg_detail img{width:54%;min-width:200px;max-width:320px;flex:0 0 auto;display:block;border-radius:6px;background:var(--alt)}\n  .kfg_detail-label{font-size:12.5px;color:#666;line-height:1.5;min-width:0}\n  .kfg_detail-label b{display:block;font-weight:600;color:var(--ink);font-size:15px;margin-bottom:var(--s-3xs)}\n  .kfg_detail-label span{display:block}\n  .kfg_detail-label em{display:block;font-style:normal;font-size:10.5px;color:#9b978c;margin-top:var(--s-2xs)}\n  @media(max-width:560px){\n    .kfg_detail{flex-direction:column;align-items:stretch;gap:var(--s-2xs)}\n    .kfg_detail img{width:100%;max-width:none}\n    .kfg_detail-label{text-align:center}\n  }\n\n  /* \u2500\u2500 Panel \u2500\u2500 */\n  .kfg_panel{display:flex;flex-direction:column;gap:var(--s-m)}\n  .kfg_step{border:1px solid var(--hair);border-radius:var(--r);padding:var(--s-s)}\n  @media(min-width:980px){.kfg_step{padding:var(--s-m)}}\n  .kfg_step-head{display:flex;align-items:baseline;gap:var(--s-xs);margin-bottom:var(--s-s)}\n  .kfg_step-num{font-weight:500;font-size:12px;color:var(--ink);letter-spacing:.06em}\n  .kfg_step-title{font-size:16px;font-weight:500}\n  .kfg_step-sub{font-size:12.5px;color:#777;margin-left:auto;text-align:right}\n  .kfg_sublabel{font-size:12px;color:#777;margin:var(--s-s) 0 var(--s-2xs)}\n\n  .kfg_mat-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:var(--s-2xs)}\n  .kfg_mat{border:1.5px solid var(--hair);border-radius:var(--r);padding:var(--s-xs);cursor:pointer;background:#fff;\n    text-align:left;transition:border-color .15s}\n  .kfg_mat.is-active{border-color:var(--ink)}\n  .kfg_mat b{display:block;font-size:13.5px;font-weight:500;line-height:1.25}\n  .kfg_mat small{font-weight:300;font-size:11px;color:#888;display:block;margin-top:var(--s-3xs);letter-spacing:.02em}\n\n  .kfg_dekor-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:var(--s-2xs);margin-top:var(--s-s)}\n  @media(min-width:560px){.kfg_dekor-grid{grid-template-columns:repeat(5,minmax(0,1fr))}}\n  .kfg_dekor{border:1.5px solid var(--hair);border-radius:var(--r);cursor:pointer;padding:var(--s-3xs);background:#fff;\n    transition:border-color .15s;display:flex;flex-direction:column}\n  .kfg_dekor.is-active{border-color:var(--ink)}\n  .kfg_dekor .sw{aspect-ratio:1/1;width:100%;border-radius:5px;display:block;background-size:165%;background-position:center}\n  .kfg_dekor span:last-child{display:block;font-size:10px;text-align:center;padding-top:var(--s-3xs);color:#666;\n    white-space:nowrap;overflow:hidden;text-overflow:ellipsis;height:17px}\n  .kfg_dekor-note{font-size:11px;color:#9b978c;margin-top:var(--s-2xs)}\n\n  .kfg_chips{display:flex;flex-wrap:wrap;gap:var(--s-2xs)}\n  .kfg_chip{border:1.5px solid var(--hair);border-radius:var(--r);background:#fff;padding:10px 16px;font-size:13.5px;\n    cursor:pointer;min-height:44px;display:inline-flex;align-items:center;gap:var(--s-2xs);transition:border-color .15s}\n  .kfg_chip.is-active{border-color:var(--ink);font-weight:500}\n  .kfg_chip small{font-size:11px;color:#888;font-weight:400}\n  .kfg_chip:disabled{opacity:.4;cursor:not-allowed}\n\n  .kfg_dims{display:grid;grid-template-columns:1fr 1fr;gap:var(--s-xs)}\n  .kfg_field label{font-size:12px;color:#777;display:block;margin-bottom:var(--s-3xs)}\n  .kfg_field .in{display:flex;align-items:center;border:1.5px solid var(--hair);border-radius:var(--r);overflow:hidden}\n  .kfg_field input{border:0;outline:0;width:100%;padding:var(--s-xs);font-size:16px;font-weight:500;min-height:44px}\n  .kfg_field .unit{padding-right:var(--s-xs);color:#999;font-size:13px}\n  .kfg_field .range{font-weight:300;font-size:11px;color:#9b978c;margin-top:var(--s-3xs);display:block;letter-spacing:.03em}\n  .kfg_field.is-error .in{border-color:#c0392b}\n  .kfg_field .err{display:none;font-size:11.5px;color:#c0392b;margin-top:var(--s-3xs)}\n  .kfg_field.is-error .err{display:block}\n  .kfg_quick{margin-top:var(--s-s)}\n  .kfg_quick p{font-size:12px;color:#777;margin-bottom:var(--s-2xs)}\n  .kfg_quick-chips{display:flex;flex-wrap:wrap;gap:6px}\n  .kfg_quick-chip{font-weight:300;font-size:12px;letter-spacing:.03em;padding:7px 10px;border:1px solid var(--hair);\n    border-radius:var(--r);background:var(--alt);cursor:pointer;transition:all .15s}\n  .kfg_quick-chip:hover{border-color:var(--ink)}\n  .kfg_quick-chip.is-active{background:var(--ink);color:#fff;border-color:var(--ink);font-weight:400}\n  .kfg_measure{margin-top:var(--s-s);font-size:13px}\n  .kfg_measure summary{cursor:pointer;color:#555;font-weight:500;list-style:none;display:inline-flex;align-items:center;gap:6px}\n  .kfg_share button{display:inline-flex;align-items:center;justify-content:center;gap:7px}\n  .kfg_measure p{margin-top:var(--s-2xs);color:#666;font-size:12.5px;line-height:1.55;background:var(--alt);\n    border-radius:var(--r);padding:var(--s-xs)}\n\n  .kfg_radius{display:flex;align-items:flex-end;gap:var(--s-xs);flex-wrap:wrap}\n  .kfg_radius .kfg_field{width:120px}\n  .kfg_radius .kfg_field input{padding:9px var(--s-xs);font-size:14px;min-height:40px}\n  .kfg_rule-note{margin-top:var(--s-2xs);font-size:12px;color:#9a6b12;background:var(--warn-bg);border-radius:var(--r);padding:var(--s-xs)}\n\n  .kfg_edge-note{margin-top:var(--s-s);font-size:12.5px;color:#666;background:var(--alt);border-radius:var(--r);\n    padding:var(--s-xs);display:flex;gap:var(--s-2xs);align-items:flex-start}\n  .kfg_trust span .ic-svg{width:13px;height:13px}\n  .kfg_mpx-note{margin-top:var(--s-2xs);font-size:12px;color:#9a6b12;background:var(--warn-bg);border-radius:var(--r);padding:var(--s-xs);display:none}\n\n  .kfg_check{display:flex;align-items:flex-start;gap:var(--s-xs);padding:var(--s-xs);border:1.5px solid var(--hair);\n    border-radius:var(--r);cursor:pointer;transition:border-color .15s}\n  .kfg_check + .kfg_check{margin-top:var(--s-2xs)}\n  .kfg_check.is-active{border-color:var(--ink)}\n  .kfg_check input{margin-top:3px;accent-color:var(--ink);width:16px;height:16px}\n  .kfg_check b{font-size:13.5px;font-weight:500;display:block}\n  .kfg_check small{font-size:12px;color:#777}\n  .kfg_check .pr{margin-left:auto;font-weight:300;font-size:12px;color:#555;white-space:nowrap;letter-spacing:.02em}\n  .kfg_custom{display:none;margin-top:var(--s-2xs);border:1.5px dashed var(--hair);border-radius:var(--r);padding:var(--s-s)}\n  .kfg_custom.is-open{display:block}\n  .kfg_custom textarea{width:100%;border:1.5px solid var(--hair);border-radius:var(--r);padding:var(--s-xs);\n    font-size:13px;min-height:64px;resize:vertical;outline:none}\n  .kfg_custom textarea:focus{border-color:var(--ink)}\n  .kfg_upload{margin-top:var(--s-2xs);border:1.5px dashed #c9c6bd;border-radius:var(--r);background:var(--alt);\n    padding:var(--s-s);text-align:center;font-size:12.5px;color:#666;cursor:pointer;transition:border-color .15s}\n  .kfg_upload:hover{border-color:var(--ink)}\n  .kfg_upload b{display:block;font-weight:500;color:var(--ink);margin-bottom:2px}\n  .kfg_custom-hint{font-size:11.5px;color:#9a6b12;margin-top:var(--s-2xs)}\n\n  .kfg_preset{display:flex;align-items:center;gap:var(--s-xs);padding:var(--s-xs);border:1.5px solid var(--hair);\n    border-radius:var(--r);transition:border-color .15s}\n  .kfg_preset + .kfg_preset{margin-top:var(--s-2xs)}\n  .kfg_preset.is-active{border-color:var(--ink)}\n  .kfg_preset b{font-size:13.5px;font-weight:500;display:block}\n  .kfg_preset small{font-size:12px;color:#777}\n  .kfg_preset .pr{margin-left:auto;font-weight:300;font-size:12px;color:#555;white-space:nowrap;letter-spacing:.02em}\n  .kfg_stepper{display:inline-flex;align-items:center;gap:2px;border:1.5px solid var(--hair);border-radius:var(--r);overflow:hidden}\n  .kfg_stepper button{border:0;background:#fff;width:36px;height:36px;font-size:17px;cursor:pointer;color:var(--ink)}\n  .kfg_stepper button:hover{background:var(--alt)}\n  .kfg_stepper [data-count]{min-width:26px;text-align:center;font-weight:500;font-size:14px}\n  .kfg_cutlist{display:flex;flex-wrap:wrap;gap:var(--s-2xs);margin-top:var(--s-2xs)}\n  .kfg_cutitem{display:inline-flex;align-items:center;gap:6px;border:1px solid var(--hair);border-radius:var(--r);\n    padding:6px 10px;font-size:12px;background:var(--alt)}\n  .kfg_cutitem button{border:0;background:none;cursor:pointer;font-size:14px;color:#999;padding:0 2px;line-height:1}\n  .kfg_cutitem button:hover{color:#c0392b}\n  #stage.is-drawing{cursor:crosshair;touch-action:none}\n  #stage.is-dragging{touch-action:none}\n  .kfg_muster{background:var(--card);border-radius:var(--r);padding:var(--s-s);display:flex;gap:var(--s-xs);align-items:center}\n  .kfg_muster .ic .ic-svg{width:22px;height:22px}\n  .kfg_muster b{font-size:13.5px;font-weight:500;display:block}\n  .kfg_muster small{font-size:12px;color:#666}\n  .kfg_muster button{margin-left:auto;border:1px solid var(--ink);background:#fff;border-radius:var(--r);\n    padding:9px 14px;font-size:12.5px;font-weight:500;cursor:pointer;white-space:nowrap;min-height:40px}\n\n  /* Summary */\n  .kfg_summary{border:1px solid var(--hair);border-radius:var(--r);padding:var(--s-s);margin-top:var(--s-s);background:#fff}\n  .kfg_sum-row{display:flex;align-items:flex-end;justify-content:space-between;gap:var(--s-s)}\n  .kfg_sum-price small{display:block;font-size:12px;color:#777}\n  .kfg_sum-price .val{font-size:30px;font-weight:600;letter-spacing:-.01em;line-height:1.1}\n  .kfg_sum-price .vat{font-size:11px;color:#999}\n  .kfg_delivery{font-size:12.5px;text-align:right}\n  .kfg_delivery b{display:block;font-weight:500}\n  .kfg_delivery span{color:#777}\n  .kfg_breakdown{margin-top:var(--s-xs);font-size:12.5px}\n  .kfg_breakdown summary{cursor:pointer;color:#555;list-style:none;display:inline-flex;gap:6px;align-items:center}\n  .kfg_breakdown summary::after{content:'\u25be';font-size:10px}\n  .kfg_breakdown table{width:100%;margin-top:var(--s-2xs);border-collapse:collapse}\n  .kfg_breakdown td{padding:var(--s-3xs) 0;color:#666;font-size:12px}\n  .kfg_breakdown td:last-child{text-align:right;font-weight:300;letter-spacing:.02em}\n  .kfg_breakdown tr.total td{border-top:1px solid var(--hair);padding-top:var(--s-2xs);color:var(--ink);font-weight:500}\n  .kfg_cta{margin-top:var(--s-s);width:100%;border:0;border-radius:var(--r);background:var(--ink);color:#fff;\n    font-size:15px;font-weight:500;padding:var(--s-s);cursor:pointer;min-height:52px;transition:background .15s}\n  .kfg_cta:hover{background:var(--deep)}\n  .kfg_cta.is-sonder{background:#fff;color:var(--ink);border:1.5px solid var(--ink)}\n  .kfg_trust{display:flex;justify-content:center;gap:var(--s-s);margin-top:var(--s-xs);font-size:11px;color:#888;flex-wrap:wrap}\n  .kfg_trust span{display:inline-flex;align-items:center;gap:5px}\n  .kfg_share{display:flex;gap:var(--s-2xs);margin-top:var(--s-s)}\n  .kfg_share button{flex:1;border:1px solid var(--hair);background:var(--alt);border-radius:var(--r);\n    padding:10px;font-size:12.5px;cursor:pointer;min-height:44px}\n  .kfg_share button:hover{border-color:var(--ink)}\n\n  /* \u2550\u2550 MOBILE \u2550\u2550 */\n  /* Sticky Mini-Vorschau: erscheint, sobald die gro\u00dfe Vorschau aus dem Bild scrollt */\n  .kfg_mini{position:fixed;left:0;right:0;z-index:45;background:#fff;border-bottom:1px solid var(--hair);\n    display:flex;align-items:center;gap:var(--s-xs);padding:var(--s-2xs) var(--s-s);\n    box-shadow:0 6px 18px rgba(0,0,0,.06);transform:translateY(-110%);transition:transform .22s ease}\n  .kfg_mini.is-on{transform:translateY(0)}\n  .kfg_mini-plate{flex:0 0 auto;height:34px;max-width:64px;border-radius:4px;background-size:cover;background-position:center;\n    border:1px solid #00000018}\n  .kfg_mini-plate.is-round{border-radius:50%}\n  .kfg_mini-txt{min-width:0;line-height:1.25}\n  .kfg_mini-txt b{display:block;font-size:12.5px;font-weight:500;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\n  .kfg_mini-txt span{display:block;font-size:11px;color:#777;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\n  .kfg_mini button{margin-left:auto;flex:0 0 auto;border:1px solid var(--hair);background:var(--alt);border-radius:var(--r);\n    padding:7px 12px;font-size:12px;cursor:pointer;min-height:36px}\n  @media(min-width:980px){.kfg_mini{display:none}}\n\n  @media(max-width:979px){\n    .kfg_hero{padding-top:var(--s-m)}\n    .kfg_hero h1{font-size:26px}\n    .kfg_hero p{font-size:14px}\n    .kfg_layout{padding-top:var(--s-2xs);gap:var(--s-s)}\n    .kfg_preview{padding:var(--s-xs)}\n    .kfg_preview-stage,#stage3d{aspect-ratio:10/6.4}\n    /* Detailansicht einklappbar, spart ~300px vor dem ersten Schritt */\n    .kfg_detail{display:block;padding:0;background:transparent}\n    .kfg_detail summary{list-style:none;cursor:pointer;display:flex;align-items:center;gap:6px;\n      font-size:12.5px;color:#555;font-weight:500;background:#fff;border-radius:var(--r);padding:10px var(--s-xs);min-height:44px}\n    .kfg_detail summary::after{content:'\u25be';margin-left:auto;font-size:10px;color:#999}\n    .kfg_detail[open] summary::after{content:'\u25b4'}\n    .kfg_detail-inner{display:flex;flex-direction:column;gap:var(--s-2xs);background:#fff;border-radius:var(--r);\n      padding:var(--s-xs);margin-top:var(--s-3xs)}\n    .kfg_detail img{width:100%;max-width:none;min-width:0}\n    .kfg_detail-badge{top:var(--s-m);left:var(--s-m)}\n    .kfg_detail-label{text-align:left}\n    /* Preset-Zeilen: Stepper unter den Text statt gequetscht daneben */\n    .kfg_preset{flex-wrap:wrap}\n    .kfg_preset .pr{margin-left:0;order:3}\n    .kfg_preset .kfg_stepper{margin-left:auto;order:4}\n    .kfg_muster{flex-wrap:wrap}\n    .kfg_muster button{margin-left:0;width:100%}\n    .kfg_modal-box{padding:var(--s-s);border-radius:12px;max-height:94vh}\n    .kfg_step{padding:var(--s-s) var(--s-xs)}\n  }\n  .kfg_bar{position:fixed;bottom:0;left:0;right:0;background:#fff;border-top:1px solid var(--hair);\n    padding:var(--s-xs) var(--s-s) calc(var(--s-xs) + env(safe-area-inset-bottom));z-index:60;\n    display:flex;align-items:center;gap:var(--s-xs);box-shadow:0 -8px 24px rgba(0,0,0,.06)}\n  .kfg_bar .p{line-height:1.15}\n  .kfg_bar .p .val{font-size:19px;font-weight:600;display:block}\n  .kfg_bar .p small{font-size:10.5px;color:#777;white-space:nowrap}\n  .kfg_bar .kfg_cta{margin:0;flex:1;padding:13px;min-height:48px;font-size:14px}\n  @media(min-width:980px){.kfg_bar{display:none}}\n\n  .kfg_modal{position:fixed;inset:0;background:rgba(10,10,10,.45);z-index:100;display:flex;align-items:center;justify-content:center;padding:var(--s-s)}\n  .kfg_modal[hidden]{display:none}\n  .kfg_modal-box{background:#fff;border-radius:16px;max-width:960px;width:100%;max-height:90vh;overflow:auto;padding:var(--s-m)}\n  .kfg_modal-head{display:flex;align-items:center;gap:var(--s-xs);margin-bottom:var(--s-s)}\n  .kfg_modal-head b{font-size:18px;font-weight:600}\n  .kfg_modal-tag{font-size:11px;color:#9a6b12;background:var(--warn-bg);border-radius:var(--r);padding:3px 8px}\n  .kfg_modal-head button{margin-left:auto;border:0;background:var(--alt);border-radius:var(--r);width:36px;height:36px;font-size:20px;cursor:pointer}\n  .kfg_modal-grid{display:grid;grid-template-columns:1fr;gap:var(--s-m)}\n  @media(min-width:760px){.kfg_modal-grid{grid-template-columns:55fr 45fr}}\n  .kfg_modal-draw{background:var(--card);border-radius:var(--r);padding:var(--s-xs)}\n  .kfg_modal-draw svg{width:100%;display:block}\n  .kfg_modal-draw p{font-size:11px;color:#8a877f;text-align:center;padding-top:var(--s-2xs)}\n  .kfg_modal-data table{width:100%;border-collapse:collapse;font-size:13px}\n  .kfg_modal-data td{padding:6px 0;border-bottom:1px solid var(--hair);vertical-align:top}\n  .kfg_modal-data td:first-child{color:#777;width:38%;padding-right:var(--s-xs)}\n  .kfg_modal-data .props{margin-top:var(--s-s);background:var(--alt);border-radius:var(--r);padding:var(--s-xs);\n    font-size:11px;color:#555;font-weight:300;letter-spacing:.02em;line-height:1.7;word-break:break-all}\n  .kfg_modal-data .props b{display:block;font-weight:500;color:var(--ink);font-size:11.5px;margin-bottom:4px;letter-spacing:0}\n  .toast{position:fixed;left:50%;bottom:96px;transform:translateX(-50%) translateY(20px);background:var(--deep);color:#fff;\n    padding:10px 18px;border-radius:var(--r);font-size:13px;opacity:0;pointer-events:none;transition:all .25s;z-index:70}\n  .toast.show{opacity:1;transform:translateX(-50%) translateY(0)}\n";
...
/* ═══════ Bilder (injiziert) ═══════ */
const ASSET=(window.__KFG_BASE||'https://cdn.jsdelivr.net/gh/SaschaKesslerPro/kessler-pro-scripts@e39f969405f6a1adc0f10ea5b6a7957711631f55')+'/assets/kfg/';
