...
export const T = {
  de: {
    ...
    dekor: 'Dekor', form: 'Form', f_rechteck: 'Rechteck', f_rund: 'Rund', f_lform: 'L-Form', f_bauch: 'Bauchausschnitt', welle_hinweis: 'Kosinuswelle, tangential — keine Ecken',
  ...
  pl: {
    ...
    dekor: 'Dekor', form: 'Kształt', f_rechteck: 'Prostokąt', f_rund: 'Okrągły', f_lform: 'Kształt L', f_bauch: 'Wycięcie brzuszne', welle_hinweis: 'Fala kosinusowa, stycznie — bez narożników',
  ...
  en: {
    ...
    dekor: 'Finish', form: 'Shape', f_rechteck: 'Rectangular', f_rund: 'Round', f_lform: 'L-shape', f_bauch: 'Belly cut-out', welle_hinweis: 'Cosine wave, tangential — no corners',
